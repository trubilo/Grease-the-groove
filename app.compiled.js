...
const GRIPS = [{
  id: "narrow",
  label: "Narrow",
  sub: "pronated · straight bar",
  color: "#00E5FF"
}, {
  id: "wide",
  label: "Wide",
  sub: "pronated · sloped handles",
  color: "#39FF14"
}, {
  id: "neutral",
  label: "Neutral",
  sub: "hammer · medium handles",
  color: "#FF9500"
}, {
  id: "chin",
  label: "Chin-up",
  sub: "supinated · close handles",
  color: "#FF4081"
}];
...
function Icon({
  ...
  const p = {
    bar: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("line", {
      x1: "18",
      y1: "20",
      x2: "18",
      y2: "10"
...
function BarChart({
  ...
  var vals = data.map(function (d) {
    return stacked ? chartTypes.reduce(function (a, g) {
      return a + safeGrip(d, g.id);
    }, 0) : valueFn(d);
  });
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("table", {
    ...
    return /*#__PURE__*/React.createElement("td", {
    ...
    }, total)), total === 0 ? /*#__PURE__*/React.createElement("div", {
      style: {
        width: "100%",
        height: "2px",
        background: "#1e1e2e"
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          width: "100%",
          height: `${sh}px`,
          background: isToday ? g.color : g.color + "99"
        }
      });
    })) : /*#__PURE__*/React.createElement("div", {
      style: {
        width: "100%",
        height: `${barH}px`,
        background: isToday ? colorFn(d, i) : colorFn(d, i) + "77",
        borderRadius: "3px 3px 0 0"
      }
    }));
  })), /*#__PURE__*/React.createElement("tr", null, data.map(function (d, i) {
    var isToday = d.date === today;
    ...
    return /*#__PURE__*/React.createElement("td", {
      ...
      style: {
        fontSize: "11px",
        color: isToday ? "#ccc" : "#555",
        lineHeight: "1.3"
      }
    }, num), !showLabel && /*#__PURE__*/React.createElement("div", {
      style: {
        height: "22px"
      }
    }));
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        fontSize: "13px",
        fontWeight: "900",
        color: r > 0 ? g.color : "#888"
      }
    }, g.label), /*#__PURE__*/React.createElement("button", {
      onClick: () => setV(g.id, r - 1),
      style: {
        width: "36px",
        height: "36px",
        borderRadius: "8px",
        border: `1px solid ${r > 0 ? g.color + "55" : "#252530"}`,
        background: "transparent",
        color: r > 0 ? g.color : "#555",
        fontSize: "20px",
        cursor: "pointer",
        display: "flex",
        alignItems: "center",
      ...
      value: r === 0 ? "" : r,
      placeholder: "0",
      onChange: e => setV(g.id, parseInt(e.target.value) || 0),
      style: inp
    ...
    style: {
      flex: 1,
      padding: "13px",
      background: `linear-gradient(135deg,${accentColor || "#BF5FFF"},${accentColor || "#7B2FFF"})`,
      border: "none",
      borderRadius: "10px",
      color: "#fff",
      fontWeight: "900",
...
function GoalModal({
  ...
  }, "BODYWEIGHT (kg)"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    value: weight,
    onChange: function (e) {
  ...
  }, "Used for tonnage and energy calculations"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "11px",
      color: "#00E5FF",
      letterSpacing: "3px",
  ...
  }, "WEEKLY PULL GOAL"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    value: goal,
    onChange: function (e) {
  ...
  }, "Pull-up reps across all grips. Increase ~20% every 4 weeks."), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "11px",
      color: "#FF6B6B",
      letterSpacing: "3px",
  ...
  }, "WEEKLY PUSH GOAL"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    value: pushGoal,
    onChange: function (e) {
      setPushGoal(e.target.value);
    },
    style: {
      ...inp,
      marginBottom: "6px"
  ...
  }, "Pushup reps across all types. Increase ~20% every 4 weeks."), /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      onSave(Number(goal) || currentGoal, Number(pushGoal) || currentPushGoal, Number(weight) || currentWeight);
    },
    style: {
      width: "100%",
      padding: "14px",
...
function InlineLogger({
  ...
  }, isDirty ? "SAVE" : "SAVED ✓"), isDirty && /*#__PURE__*/React.createElement("button", {
    onClick: onCancel,
    style: {
      padding: "12px 16px",
      background: "transparent",
...
function App() {
  ...
  const setGripVal = (id, val) => setDraft(prev => ({
    ...(prev !== null ? prev : savedLog),
    [id]: Math.max(0, val)
  }));

  // ── Push draft ──
  const savedPushLog = pushLogs[today] || {
    wide: 0,
    standard: 0,
    diamond: 0
  };
  ...
  const setPushGripVal = (id, val) => setPushDraft(prev => ({
    ...(prev !== null ? prev : savedPushLog),
    [id]: Math.max(0, val)
  }));
  ...
  const weekReps = useMemo(() => Object.entries(logs).filter(([d]) => getWeekStart(d) === weekStart).reduce((a, [, v]) => a + GRIPS.reduce((b, g) => b + (v[g.id] || 0), 0), 0), [logs, weekStart]);
  ...
  // ── Push week stats ──
  const pushWeekReps = useMemo(() => Object.entries(pushLogs).filter(([d]) => getWeekStart(d) === weekStart).reduce((a, [, v]) => a + PUSH_TYPES.reduce((b, g) => b + (v[g.id] || 0), 0), 0), [pushLogs, weekStart]);
  const pushWeekPct = pushGoal ? pushWeekReps / pushGoal : 0;

  // ── Pull all-time ──
  const allReps = useMemo(() => Object.values(logs).reduce((a, v) => a + GRIPS.reduce((b, g) => b + (v[g.id] || 0), 0), 0), [logs]);
  const allTonnage = allReps * bodyweight;
  const allJoules = allReps * joulesPerRep;
  const allKcal = allReps * kcalPerRep;

  // ── Push all-time ──
  const pushAllReps = useMemo(() => Object.values(pushLogs).reduce((a, v) => a + PUSH_TYPES.reduce((b, g) => b + (v[g.id] || 0), 0), 0), [pushLogs]);
  // Tonnage = effective weight moved per type (bwFraction × bodyweight × reps)
  const pushAllTonnage = useMemo(() => Object.values(pushLogs).reduce((a, v) => a + PUSH_TYPES.reduce((b, t) => b + (v[t.id] || 0) * bodyweight * t.bwFraction, 0), 0), [pushLogs, bodyweight]);
  // Energy: per-type bwFraction and rom (not identical to pull-up formula)
  const pushAllJoules = useMemo(() => Object.values(pushLogs).reduce((a, v) => a + pushJoulesForEntry(v, bodyweight), 0), [pushLogs, bodyweight]);
  ...
  const last7 = getLast7Days().map(function (d) {
    ...
    return {
      date: d,
      reps: GRIPS.reduce((a, g) => a + (entry[g.id] || 0), 0),
      grips: {
  ...
  const last8weeks = useMemo(() => getLast8Weeks().map(ws => ({
    weekStart: ws,
    reps: Object.entries(logs).filter(([d]) => getWeekStart(d) === ws).reduce((a, [, v]) => a + GRIPS.reduce((b, g) => b + (v[g.id] || 0), 0), 0)
  })), [logs]);
  const allTimeWeeks = useMemo(() => {
    var allDates = Object.keys(logs).sort();
    if (allDates.length === 0) return last8weeks;
    var cur = new Date(getWeekStart(allDates[0])),
      todayW = localDateStr(new Date()),
      weeks = [];
  ...
  const pushLast7 = getLast7Days().map(function (d) {
    ...
    return {
      date: d,
      reps: PUSH_TYPES.reduce((a, g) => a + (entry[g.id] || 0), 0),
      grips: {
        wide: entry.wide || 0,
        standard: entry.standard || 0,
        diamond: entry.diamond || 0
      }
    };
  });
  const pushLast8weeks = useMemo(() => getLast8Weeks().map(ws => ({
    weekStart: ws,
    reps: Object.entries(pushLogs).filter(([d]) => getWeekStart(d) === ws).reduce((a, [, v]) => a + PUSH_TYPES.reduce((b, g) => b + (v[g.id] || 0), 0), 0)
  })), [pushLogs]);
  ...
  const weekGripReps = useMemo(() => {
    ...
    Object.entries(logs).filter(([d]) => getWeekStart(d) === weekStart).forEach(([, v]) => GRIPS.forEach(g => {
      t[g.id] += v[g.id] || 0;
    }));
    return t;
  }, [logs, weekStart]);
  const pushWeekTypeReps = useMemo(() => {
    ...
    Object.entries(pushLogs).filter(([d]) => getWeekStart(d) === weekStart).forEach(([, v]) => PUSH_TYPES.forEach(g => {
      t[g.id] += v[g.id] || 0;
    }));
    return t;
  }, [pushLogs, weekStart]);
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, nav === "today" && /*#__PURE__*/React.createElement("div", {
    style: {
      paddingBottom: "80px"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      background: "linear-gradient(180deg,#0c0c1e,#07070e)"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "14px",
  ...
  }, "GTG TRACKER"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "15px",
      color: "#ddd",
      marginBottom: "20px"
  ...
  }, "WEEKLY GOALS"), /*#__PURE__*/React.createElement("button", {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, row.reps), /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1
      }
    }, /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        height: "100%",
        background: row.pct >= 1 ? "#39FF14" : row.color,
        borderRadius: "4px",
      ...
      style: {
        fontSize: "11px",
        color: row.pct >= 1 ? "#39FF14" : "#555",
        minWidth: "52px",
        textAlign: "right"
      }
    }, row.pct >= 1 ? "✓ DONE" : row.goal - row.reps + " left")), /*#__PURE__*/React.createElement("div", {
      style: {
        paddingLeft: "102px",
        fontSize: "11px",
        color: "#555"
      }
    }, Math.round(row.pct * 100), "% of ", row.goal, " reps"));
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: "8px",
    ...
    label: "TONNAGE",
    val: `${(weekTonnage / 1000).toFixed(2)}t`,
    color: "#FF9500"
  }, {
    label: "ENERGY",
    val: `${Math.round(weekKjoules)}kJ`,
    color: "#00E5FF"
  }, {
    label: "KCAL",
    val: `${weekKcal.toFixed(1)}`,
    color: "#39FF14"
  }].map(function (s) {
    return /*#__PURE__*/React.createElement("div", {
      key: s.label,
  ...
  }))), /*#__PURE__*/React.createElement(InlineLogger, {
    title: "PULL-UPS",
    types: GRIPS,
    todayLog: todayLog,
    isDirty: isDirty,
  ...
  }, "PULLS"), /*#__PURE__*/React.createElement(BarChart, {
    data: last7,
    height: 60,
    valueFn: d => d.reps,
    labelFn: d => formatDate(d.date),
    colorFn: d => d.date === today ? "#00E5FF" : "#00E5FF66",
    stacked: true,
    types: GRIPS
  }), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "PUSHES"), /*#__PURE__*/React.createElement(BarChart, {
    data: pushLast7,
    height: 60,
    valueFn: d => d.reps,
    labelFn: d => formatDate(d.date),
    colorFn: d => d.date === today ? "#FF6B6B" : "#FF6B6B66",
    stacked: true,
    types: PUSH_TYPES
  }))), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "THIS WEEK BY TYPE"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "12px",
      color: "#888",
      marginBottom: "10px",
  ...
  }, "PULL-UPS"), GRIPS.map(g => {
    const r = weekGripReps[g.id] || 0,
      pct = weekReps > 0 ? r / weekReps : 0;
    return /*#__PURE__*/React.createElement("div", {
      key: g.id,
      style: {
        marginBottom: "10px"
      ...
      style: {
        fontSize: "13px",
        fontWeight: "700",
        color: r > 0 ? g.color : "#ccc"
      }
    }, g.label), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: "13px",
        color: r > 0 ? g.color : "#bbb",
        fontWeight: "900"
      }
  ...
  }, "PUSHUPS"), PUSH_TYPES.map(g => {
    const r = pushWeekTypeReps[g.id] || 0,
      pct = pushWeekReps > 0 ? r / pushWeekReps : 0;
    return /*#__PURE__*/React.createElement("div", {
      key: g.id,
      style: {
        marginBottom: "10px"
  ...
  }, "TODAY'S ENERGY"), todayReps === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "13px",
      color: "#555",
      textAlign: "center",
  ...
  }, "Log pull-ups to see energy output") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
    ...
    label: "MECHANICAL",
    val: `${Math.round(todayReps * joulesPerRep)} J`,
    color: "#00E5FF"
  }, {
    label: "METABOLIC",
    val: `${Math.round(todayReps * metabolicJPerRep / 1000)} kJ`,
    color: "#39FF14"
  }, {
    label: "TONNAGE",
    val: `${(todayReps * bodyweight).toLocaleString()} kg`,
    color: "#FF9500"
  }, {
    label: "KCAL",
    val: `${(todayReps * kcalPerRep).toFixed(1)}`,
    color: "#FF4081"
  }].map(function (s) {
    return /*#__PURE__*/React.createElement("div", {
      key: s.label,
    ...
    var todayJ = todayReps * metabolicJPerRep,
      pct = Math.min(100, Math.round(todayJ / e.metabolicJ * 100));
    return /*#__PURE__*/React.createElement("div", {
      key: e.label,
      style: {
        marginBottom: "10px"
    ...
    }, e.emoji, " ", e.label), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: "13px",
        color: "#00E5FF",
        fontWeight: "900"
  ...
  }))))), nav === "stats" && /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "PULL-UPS"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "24px",
    ...
    label: "TOTAL REPS",
    val: allReps.toLocaleString(),
    color: "#00E5FF"
  }, {
    label: "TONNAGE",
    val: `${(allTonnage / 1000).toFixed(1)}t`,
    color: "#FF9500"
  }, {
    label: "ENERGY",
    val: `${Math.round(allJoules / 1000)} kJ`,
    color: "#39FF14"
  }, {
    label: "KCAL",
    val: `${Math.round(allKcal)}`,
    color: "#FF4081"
    ...
    return /*#__PURE__*/React.createElement("button", {
      key: pair[0],
      onClick: () => setChartScale(pair[0]),
      style: {
        flex: 1,
        padding: "7px 4px",
        background: active ? "#00E5FF" : "transparent",
        border: `1px solid ${active ? "#00E5FF" : "#2a2a3a"}`,
        borderRadius: "8px",
  ...
  })), chartScale === "week" && /*#__PURE__*/React.createElement(BarChart, {
    data: last7,
    height: 80,
    valueFn: d => d.reps,
    labelFn: d => formatDate(d.date),
    ...
    stacked: true,
    types: GRIPS
  }), chartScale === "month" && /*#__PURE__*/React.createElement(BarChart, {
    data: getLast30Days().map(d => {
      var e = logs[d] || {};
      return {
        date: d,
        reps: GRIPS.reduce((a, g) => a + (e[g.id] || 0), 0),
        grips: {
          narrow: e.narrow || 0,
          wide: e.wide || 0,
          neutral: e.neutral || 0,
    ...
    labelEvery: 5,
    types: GRIPS
  }), chartScale === "alltime" && /*#__PURE__*/React.createElement(BarChart, {
    data: allTimeWeeks,
    height: 80,
    valueFn: d => d.reps,
    labelFn: d => {
  ...
  }, "ALL TIME BY GRIP"), GRIPS.map(g => {
    const r = Object.values(logs).reduce((a, v) => a + (v[g.id] || 0), 0),
      pct = allReps > 0 ? r / allReps : 0;
    return /*#__PURE__*/React.createElement("div", {
      key: g.id,
      style: {
        marginBottom: "12px"
  ...
  }, "PUSHUPS"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "24px",
      fontFamily: "Georgia,serif",
      fontWeight: "900",
    ...
    label: "TOTAL REPS",
    val: pushAllReps.toLocaleString(),
    color: "#FF6B6B"
  }, {
    label: "TONNAGE",
    val: `${(pushAllTonnage / 1000).toFixed(1)}t`,
    color: "#FBBF24"
  }, {
    label: "ENERGY",
    val: `${Math.round(pushAllJoules / 1000)} kJ`,
    color: "#A78BFA"
  }, {
    label: "KCAL",
    val: `${Math.round(pushAllKcal)}`,
    color: "#FF6B6B"
  }].map(s => /*#__PURE__*/React.createElement("div", {
    key: s.label,
    style: {
    ...
    return /*#__PURE__*/React.createElement("button", {
      key: pair[0],
      onClick: () => setPushChartScale(pair[0]),
      style: {
        flex: 1,
        padding: "7px 4px",
        background: active ? "#FF6B6B" : "transparent",
        border: `1px solid ${active ? "#FF6B6B" : "#2a2a3a"}`,
        borderRadius: "8px",
        color: active ? "#000" : "#888",
        fontSize: "11px",
        fontWeight: "900",
  ...
  })), pushChartScale === "week" && /*#__PURE__*/React.createElement(BarChart, {
    data: pushLast7,
    height: 80,
    valueFn: d => d.reps,
    labelFn: d => formatDate(d.date),
    ...
    stacked: true,
    types: PUSH_TYPES
  }), pushChartScale === "month" && /*#__PURE__*/React.createElement(BarChart, {
    data: getLast30Days().map(d => {
      var e = pushLogs[d] || {};
      return {
        date: d,
        reps: PUSH_TYPES.reduce((a, g) => a + (e[g.id] || 0), 0),
        grips: {
          wide: e.wide || 0,
          standard: e.standard || 0,
          diamond: e.diamond || 0
        }
      };
    }),
    ...
    labelEvery: 5,
    types: PUSH_TYPES
  }), pushChartScale === "alltime" && /*#__PURE__*/React.createElement(BarChart, {
    data: pushAllTimeWeeks,
    height: 80,
    valueFn: d => d.reps,
    labelFn: d => {
      var dt = new Date(d.weekStart);
    ...
    goal: pushGoal,
    labelEvery: pushAllTimeWeeks.length > 16 ? 4 : pushAllTimeWeeks.length > 8 ? 2 : 1
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "#0c0c1c",
      borderRadius: "14px",
  ...
  }, "ALL TIME BY TYPE"), PUSH_TYPES.map(g => {
    const r = Object.values(pushLogs).reduce((a, v) => a + (v[g.id] || 0), 0),
      pct = pushAllReps > 0 ? r / pushAllReps : 0;
    return /*#__PURE__*/React.createElement("div", {
      key: g.id,
      style: {
        marginBottom: "12px"
  ...
  }, "Rep Log"), historyDates.length === 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      padding: "40px 20px",
      color: "#ccc",
  ...
  }, "No reps logged yet.", /*#__PURE__*/React.createElement("br", null), "Log reps on the Today tab."), historyDates.map(date => {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, tonnage.toLocaleString(), " kg total")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        alignItems: "center",
        gap: "6px"
      }
    }, pullTotal > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: "18px",
        fontWeight: "900",
        color: "#00E5FF"
      }
    }, pullTotal, /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: "11px",
        color: "#555",
        marginLeft: "2px"
      }
    }, "\u2191")), pushTotal > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: "18px",
        fontWeight: "900",
        color: "#FF6B6B"
      }
    }, pushTotal, /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: "11px",
        color: "#555",
        marginLeft: "2px"
      }
    }, "\u2193")), pullEntry && /*#__PURE__*/React.createElement("button", {
      ...
      name: "edit",
      size: 15
    })), pushEntry && /*#__PURE__*/React.createElement("button", {
      onClick: () => setEditPushDate(date),
      style: {
        background: "none",
        border: "none",
        cursor: "pointer",
      ...
      onClick: () => {
        if (window.confirm("Delete all entries for this day?")) {
          if (pullEntry) deleteLog(date);
          if (pushEntry) deletePushLog(date);
        }
      },
      style: {
        background: "none",
      ...
      name: "trash",
      size: 15
    })))), pullEntry && pullTotal > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: "5px",
        flexWrap: "wrap",
        marginBottom: pushEntry && pushTotal > 0 ? "6px" : "0"
      }
    }, GRIPS.map(g => {
      const r = pullEntry[g.id] || 0;
      return r > 0 ? /*#__PURE__*/React.createElement("div", {
        key: g.id,
        style: {
          padding: "3px 7px",
    ...
    })), pushEntry && pushTotal > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: "5px",
        flexWrap: "wrap"
  ...
  }, item.label)))), editDate && /*#__PURE__*/React.createElement(EditLogModal, {
    date: editDate,
    types: GRIPS,
    accentColor: "#BF5FFF",
    existing: logs[editDate] || {
      narrow: 0,
      wide: 0,
      neutral: 0,
      chin: 0
  ...
  }), editPushDate && /*#__PURE__*/React.createElement(EditLogModal, {
    date: editPushDate,
    types: PUSH_TYPES,
    accentColor: "#FF6B6B",
    existing: pushLogs[editPushDate] || {
      wide: 0,
      standard: 0,
      diamond: 0
    },
    ...
    onSave: reps => {
      ...
      setEditPushDate(null);
    },
    onDelete: () => {
      deletePushLog(editPushDate);
      setEditPushDate(null);
    }
  }), showGoal && /*#__PURE__*/React.createElement(GoalModal, {
    currentGoal: weekGoal,
    currentPushGoal: pushGoal,
    currentWeight: bodyweight,
    onClose: () => setShowGoal(false),
    onSave: function (g, pg, w) {
      setWeekGoal(g);
      setPushGoal(pg);
      setBodyweight(w);
      BODYWEIGHT_KG = w;
