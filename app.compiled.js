...
function BarChart({
  ...
  var vals = data.map(function (d) {
    return stacked ? GRIPS.reduce(function (a, g) {
...
function GoalModal({
  ...
  }, "WEEKLY REP GOAL"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    value: goal,
    onChange: function (e) {
  ...
  }, "Total reps across all grips. Increase ~20% every 4 weeks."), /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      onSave(Number(goal) || currentGoal, Number(weight) || currentWeight);
    },
    style: {
      width: "100%",
      padding: "14px",
...
function App() {
  ...
  const weekReps = useMemo(() => {
    return Object.entries(logs).filter(([d]) => getWeekStart(d) === weekStart).reduce((a, [, v]) => a + GRIPS.reduce((b, g) => b + (v[g.id] || 0), 0), 0);
  }, [logs, weekStart]);
  ...
  const last7 = getLast7Days().map(function (d) {
    ...
    return {
      date: d,
      reps: GRIPS.reduce(function (a, g) {
        return a + (entry[g.id] || 0);
      }, 0),
      grips: {
  ...
  const last8weeks = useMemo(() => {
    ...
    return weeks.map(function (ws) {
      return {
        weekStart: ws,
        reps: Object.entries(logs).filter(function (pair) {
          return getWeekStart(pair[0]) === ws;
        }).reduce(function (a, pair) {
          return a + GRIPS.reduce(function (b, g) {
            return b + (pair[1][g.id] || 0);
          }, 0);
        }, 0)
      };
    });
  ...
  const allTimeWeeks = useMemo(() => {
    ...
    while (localDateStr(cur) <= todayW) {
      ...
      weeks.push({
        weekStart: ws,
        reps: Object.entries(logs).filter(function (p) {
          return getWeekStart(p[0]) === ws;
        }).reduce(function (a, p) {
          return a + GRIPS.reduce(function (b, g) {
            return b + (p[1][g.id] || 0);
          }, 0);
  ...
  // Sorted history
  const historyDates = useMemo(() => Object.keys(logs).sort((a, b) => b.localeCompare(a)), [logs]);
  const NAV = [{
    id: "today",
    icon: "flame",
    label: "TODAY"
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "GTG PULL TRACKER"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "15px",
      color: "#ddd",
      marginBottom: "20px"
  ...
  }, "WEEKLY GOAL"), /*#__PURE__*/React.createElement("button", {
  ...
  }, weekReps), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, Math.round(weekPct * 100), "% of ", weekGoal, " reps"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "12px",
      color: weekPct >= 1 ? "#39FF14" : "#555"
    }
  }, weekPct >= 1 ? "✓ DONE" : weekGoal - weekReps + " to go")))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: "8px",
      marginTop: "10px"
    ...
    style: {
      ...
      borderRadius: "12px",
      padding: "16px",
      border: `1px solid ${isDirty ? "#00E5FF44" : "#1a1a2a"}`
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
  ...
  }, "reps per day"), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative"
    }
    ...
    }, r, " reps")), /*#__PURE__*/React.createElement("div", {
      style: {
        height: "6px",
        background: "#1a1a2a",
        borderRadius: "3px",
  ...
  }, "Log reps to see energy output") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, "Muscles are ~25% efficient \u2014 4J burned for every 1J of movement. The other 3J become heat. That's why metabolic cost = mechanical \xD7 4."), [{
    label: "Boil 1L water",
    metabolicJ: 857000,
    emoji: "☕"
  }, {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        border: `1px solid ${active ? "#FF9500" : "#2a2a3a"}`,
        borderRadius: "8px",
    ...
    colorFn: function (d) {
      return d.date === today ? "#FF9500" : "#FF950066";
    },
    stacked: true
    ...
    colorFn: function (d) {
      return getWeekStart(today) === d.weekStart ? "#FF9500" : "#FF950066";
    },
    goal: weekGoal,
    ...
    }, t.toLocaleString(), " kg"))), /*#__PURE__*/React.createElement("div", {
      style: {
        height: "6px",
        background: "#1a1a2a",
        borderRadius: "3px",
    ...
    metabolicJ: 857000,
    emoji: "☕",
    note: "150kJ electrical ÷ 25% efficiency"
  }, {
    label: "iPhone full charge",
    metabolicJ: 280000,
    emoji: "📱",
    note: "14Wh battery ÷ 25% muscle eff."
  }, {
    label: "LED bulb for 1 hour",
    metabolicJ: 206000,
    emoji: "💡",
    note: "10W × 3600s ÷ 25% efficiency"
  }, {
    ...
    }, repsNeeded, " reps"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: "13px",
        color: "#ccc"
      }
  ...
  }, "Your ", allReps, " lifetime reps = ", Math.round(allJoules / 1000), " kJ mechanical energy. Metabolically that's ", Math.round(allKcal), " kcal \u2014 enough to ", allKcal > 300 ? "run about " + Math.round(allKcal / 60) + "km" : "make a decent dent in a snack", "."))), nav === "history" && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "22px 16px 88px"
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "No reps logged yet.", /*#__PURE__*/React.createElement("br", null), "Hit LOG REPS on the Today tab."), historyDates.map(date => {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, tonnage.toLocaleString(), " kg \xB7 ", kj, " kJ")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        alignItems: "center",
        gap: "8px"
      ...
      onClick: () => {
        if (window.confirm("Delete this entry?")) deleteLog(date);
      },
      style: {
        background: "none",
        border: "none",
